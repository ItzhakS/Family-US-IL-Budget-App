...
const AppShellInner: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
        <div className="max-w-xl w-full bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
          ...
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-2">Setup Required</h1>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-indigo-50 dark:bg-indigo-950/40 p-4 rounded-xl border border-indigo-100 dark:border-indigo-900">
              ...
              <ul className="text-xs font-mono bg-white dark:bg-gray-900 p-3 rounded mt-2 border border-indigo-100 dark:border-indigo-900 text-gray-600 dark:text-gray-300">
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 pb-20 text-gray-900 dark:text-gray-50">
      <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center gap-2 min-h-14 py-1.5 md:py-0 md:h-16">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
              ...
              <div className="hidden md:flex items-center gap-3 shrink-0">
                {isDemoMode && (
                  <span className="rounded-md bg-amber-100 dark:bg-amber-900/30 text-amber-900 dark:text-amber-300 text-xs font-bold px-2 py-1 border border-amber-200 dark:border-amber-800 tracking-wide whitespace-nowrap">
                    TEST VIEW
                  </span>
                )}
                {exchangeRate && (
              ...
              <div className="flex items-center gap-2 min-w-0 shrink-0">
                ...
                <h1 className="text-base sm:text-xl font-bold text-gray-900 dark:text-gray-50 tracking-tight truncate hidden sm:block">
                  Family Budget
                </h1>
              </div>

              <div className="h-6 w-px bg-gray-200 dark:bg-gray-700 hidden md:block shrink-0" />
            ...
            <div className="flex items-center gap-1 sm:gap-3 shrink-0">
              {dataLoading && <Loader2 className="animate-spin text-indigo-600 dark:text-indigo-400 hidden sm:block" size={16} />}
              ...
              <button
                type="button"
                onClick={toggleTheme}
                className="p-2 text-gray-500 dark:text-gray-400 hover:text-indigo-600 dark:hover:text-indigo-300 hover:bg-indigo-50 dark:hover:bg-gray-700 rounded-lg transition-colors focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-400 text-white px-3 sm:px-4 py-2 rounded-lg text-sm font-medium transition-colors shadow-sm focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
              >
                <Plus size={18} />
              ...
              <button
                type="button"
                onClick={() => void logout()}
                className="p-2 text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/40 rounded-lg transition-colors focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
          ...
          <div className="md:hidden flex items-center gap-2 pb-2 overflow-x-auto">
            {isDemoMode && (
              <span className="shrink-0 rounded-md bg-amber-100 dark:bg-amber-900/30 text-amber-900 dark:text-amber-300 text-[10px] font-bold px-2 py-1 border border-amber-200 dark:border-amber-800 tracking-wide whitespace-nowrap">
                TEST VIEW
              </span>
            )}
            {exchangeRate && (
              <div className="shrink-0 text-[10px] text-gray-600 dark:text-gray-300 bg-gray-50 dark:bg-gray-900 px-2 py-1 rounded-lg border border-gray-200 dark:border-gray-700 whitespace-nowrap">
                <span className="font-semibold">$1 = ₪{exchangeRate.usdToIls.toFixed(2)}</span>
      ...
      {mobileNavOpen && (
        <>
          ...
          />
          <div
            className="fixed top-0 left-0 z-50 h-full w-[min(20rem,92vw)] bg-white dark:bg-gray-800 shadow-2xl md:hidden flex flex-col border-r border-gray-100 dark:border-gray-700"
            role="dialog"
            aria-modal="true"
          ...
          >
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center gap-3 px-3 py-3 rounded-xl text-sm font-medium transition-colors ${
                      isActive ? 'bg-indigo-50 dark:bg-indigo-950/50 text-indigo-900 dark:text-indigo-200' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700'
                    }`
                  }
                >
            ...
            <div className="p-4 border-t border-gray-100 dark:border-gray-700">
              <button
                ...
                className="w-full inline-flex items-center justify-center gap-2 bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-400 text-white px-4 py-3 rounded-xl text-sm font-medium shadow-sm"
              >
                <Plus size={18} />
                Add transaction
              </button>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <nav className="hidden md:flex flex-wrap gap-1 bg-gray-100 dark:bg-gray-800 p-1 rounded-xl mb-8 w-full lg:w-auto">
          {navItems.map(({ to, label, icon: Icon }) => (
            <NavLink
              key={to}
              to={to}
              className={({ isActive }) =>
                `flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-all whitespace-nowrap ${
                  isActive ? 'bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-50 shadow-sm' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200'
                }`
              }
            >
              <Icon size={18} />
